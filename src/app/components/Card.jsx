    ...
    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm h-full flex flex-col hover:shadow-md transition-shadow">
      ...
      <div className="p-5 flex flex-col flex-grow">
        ...
        <div className="mb-3 font-normal text-gray-700 flex-grow">
          ...
          {products?.length > 0 && (
            <p className="text-sm mt-1">
              <span className="font-semibold">منتجات:</span> {products.slice(0, 2).join('، ')}...
            </p>
          )}
          
          {services?.length > 0 && (
            <p className="text-sm mt-1">
              <span className="font-semibold">خدمات:</span> {services.slice(0, 2).join('، ')}...
            </p>
          )}
        </div>
          ...
          <Link 
            href={{
              ...
              query: { 
                ...
                mission: typeof mission === 'string' ? mission : JSON.stringify(mission),
                phone,
                address,
