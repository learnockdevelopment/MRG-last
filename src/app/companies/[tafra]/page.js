...
export default function CompanyPage() {
  ...
  const training_fields = JSON.parse(searchParams.get("training_fields") || "[]");
  ...
  >
    <div className="bg-gradient-to-br from-green-50 to-white rounded-3xl shadow-xl overflow-hidden border border-green-100">
      ...
      <div className="bg-green-600 px-8 py-4">
        <h2 className="text-3xl font-bold text-white text-center">معلومات الشركة</h2>
      </div>
          ...
          {description && (
            ...
            >
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-2xl font-semibold mb-4 text-green-800">نبذة عن الشركة</h3>
              ...
              {phone && (
                <div className="flex items-center gap-4 bg-green-50 p-4 rounded-xl">
                  ...
                  <div>
                    ...
                    <a href={`tel:${phone}`} className="text-xl font-medium text-green-700 hover:text-green-800 transition-colors">
                      {phone}
                    </a>
                  </div>
                </div>
      ...
      {(mission.length > 0 || goals.length > 0 || vision) && (
        <div className="container mx-auto px-4 lg:px-8 mt-32 mb-20" style={{ direction: "rtl" }}>
          ...
          <div className="flex gap-6 justify-center items-center text-center flex-wrap">
            ...
            {mission.length > 0 && (
              <div className="p-4 py-8 w-96 min-h-[590px] bg-green-50 rounded-2xl shadow-[0px_4px_4px_4px_rgba(0,0,0,0.25)] backdrop-blur-lg flex flex-col justify-start items-center gap-6">
                <h1 className="text-black text-2xl font-bold font-['Open_Sans']">رسالة الشركة</h1>
            ...
            {goals.length > 0 && (
              <div className="p-4 py-8 w-96 min-h-[590px] bg-green-50 rounded-2xl shadow-[0px_4px_4px_4px_rgba(0,0,0,0.25)] backdrop-blur-lg flex flex-col justify-start items-center gap-6">
                <h1 className="text-black text-2xl font-bold font-['Open_Sans']">أهداف الشركة</h1>
            ...
            {vision && (
              <div className="p-4 py-8 w-96 min-h-[590px] bg-green-50 rounded-2xl shadow-[0px_4px_4px_4px_rgba(0,0,0,0.25)] backdrop-blur-lg flex flex-col justify-start items-center gap-6">
                <h1 className="text-black text-2xl font-bold font-['Open_Sans']">رؤية الشركة</h1>
     ...
     {(products.length > 0 || services.length > 0 || values.length > 0 || 
  branches.length > 0 || training_fields.length > 0 || advantages.length > 0) && (
  <motion.div
  ...
  >
    <div className="bg-gradient-to-br from-white to-green-50 rounded-3xl shadow-xl overflow-hidden border border-green-100">
      ...
      <div className="bg-green-700 px-8 py-5">
        <h2 className="text-3xl font-bold text-white text-center">تفاصيل الشركة</h2>
      </div>
          ...
          {products.length > 0 && (
            ...
            >
              <div className="bg-green-100 px-6 py-4 flex items-center gap-3">
                ...
                <h3 className="text-xl font-bold text-green-800">المنتجات</h3>
              </div>
              <div className="p-6">
          ...
          {services.length > 0 && (
            ...
            >
              <div className="bg-green-100 px-6 py-4 flex items-center gap-3">
                ...
                <h3 className="text-xl font-bold text-green-800">الخدمات</h3>
              </div>
              <div className="p-6">
                <ul className="space-y-3">
          ...
          {values.length > 0 && (
            ...
            >
              <div className="bg-green-100 px-6 py-4 flex items-center gap-3">
                ...
                <h3 className="text-xl font-bold text-green-800">القيم</h3>
              </div>
              <div className="p-6">
                <ul className="space-y-3">
          ...
          {branches.length > 0 && (
            ...
            >
              <div className="bg-green-100 px-6 py-4 flex items-center gap-3">
                ...
                <h3 className="text-xl font-bold text-green-800">الفروع</h3>
              </div>
              <div className="p-6">
                <ul className="space-y-3">
          ...
          {training_fields.length > 0 && (
            ...
            >
              <div className="bg-green-100 px-6 py-4 flex items-center gap-3">
                ...
                <h3 className="text-xl font-bold text-green-800">مجالات التدريب</h3>
              </div>
              <div className="p-6">
                <ul className="space-y-3">
          ...
          {advantages.length > 0 && (
            ...
            >
              <div className="bg-green-100 px-6 py-4 flex items-center gap-3">
                ...
                <h3 className="text-xl font-bold text-green-800">المميزات</h3>
              </div>
              <div className="p-6">
                <ul className="space-y-3">
